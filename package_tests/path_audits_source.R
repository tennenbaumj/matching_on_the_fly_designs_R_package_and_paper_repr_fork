...
audit_classes = list(
  ...
  list(name="InferenceSurvivalKKWeibullFrailtyOneLik", section="Survival",  resp="surv", kk=TRUE,  types="full", skip_asymp=FALSE, skip_ci=FALSE,   skip_boot=TRUE,  skip_bbt=TRUE,  jack=TRUE, skip_rand=FALSE, rand_resp="csp", skip_rpv=FALSE, skip_rci=FALSE, rci_resp="surv", pboot=TRUE,  slow_methods=c("compute_rand_confidence_interval"), notes="AbstractKKWeibullFrailtyOneLik → ParamBootstrap; pboot=use_rcpp; skip_boot=TRUE; rand CI avg 45.7s / max 171.5s at n=6 slow"),
